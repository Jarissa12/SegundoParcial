...
{
    public partial class Registrov : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Verdura", x => x.VerduraId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vitamina", x => x.VitaminaId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VerdurasDetalles", x => x.VerduraId);
                    table.ForeignKey(
                        name: "FK_VerdurasDetalles_Verdura_VerduraId",
                        column: x => x.VerduraId,
                        principalTable: "Verdura",
